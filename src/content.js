...
const content = {
  ...
  interview: {
    ...
    intro: "The following audio clips are excerpted from the interview I recorded with my mom, Robin Miller, in May 2026. Each clip clip is accompanied by a short description and significant quote.",
    clips: [
      {
        id: "clip1",
        title: "THE ENEMY",
  ...
  reflection: {
    ...
    paragraphs: [
      "Going into this project I figured my mom's interview would mostly be about significant historical events. The Berlin Wall coming down, the Gulf War on TV, the Soviet Union ending. And she did talk about all of that. But the stuff that actually stuck with me was different from what I expected.",
